...
import { FieldPath, FieldValues, RegisterOptions, type UseFormRegister } from "react-hook-form";
...
export default function Input<TFieldValues extends FieldValues>({
	...
	classNameEye = "absolute h-5 w-5 cursor-pointer top-[12px] right-[8px]",
	name,
	register,
	rules,
	...rest
	...
	return (
		<div className={"relative " + className}>
			<input {...registerResult} className={classNameInput} {...rest} type={handleType()} />
